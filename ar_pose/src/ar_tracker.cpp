...
// char           *patt_name[NMARKERS]      = {"data/robot/patt.hiro", "data/robot/patt.kanji", "data/robot/patt.sample1", "data/robot/patt.sample2"};
char           *patt_name[NMARKERS]      = {"data/multi/patt.letter_a", "data/multi/patt.letter_b", "data/multi/patt.letter_c", "data/multi/patt.letter_d", "data/multi/patt.letter_f", "data/multi/patt.letter_g"};
// char           *patt_name[NMARKERS]      = {"data/multi/patt.letter_a", "data/multi/patt.letter_b"};
...
int main(int argc, char **argv)
{
	...
	arMarkerPub = n.advertise<ar_pose::ARMarker>("ar_pose_marker", 0);
